    ...
    return (
        <Box p="6" border={'1px solid'} borderColor={'gray.100'} overflow={'hidden'} borderRadius={'10'} background={'white'} display={'flex'}>
            <Flex
                ...
                <Flex
                    flex={1} w={'full'} flexDirection={'column'} alignItems={'center'} justifyContent={'space-evenly'} ml={-20} mr={'2'}>
                    <Heading size={'md'} mb={'4'} color={'gray.600'}>
                    Balance is $ {totalIncome - totalExpense}
                    </Heading>

                    <Flex justifyContent={'space-evenly'} alignItems={'center'} bg={'gray.50'} w='50%' h='100px' border={'1px solid'} borderColor={'gray.100'} mb={5} borderRadius={10}>
                    ...
                    <Flex justifyContent={'space-evenly'} alignItems={'center'} bg={'gray.50'} w='50%' h='100px' border={'1px solid'} borderColor={'gray.100'} borderRadius={10}>
                        <Flex flexDirection={'column'}>
                            <Heading color={'gray.700'}>
                                $  {totalExpense}
                            </Heading>
                ...
                <Box flex={1} mt={'10'} ml={'-90px'} mr={'5'} width={'300px'} height={'300px'} display={'flex'} alignItems={'center'} justifyContent={'center'}>
                    <Heading><TransactionChart expense={totalExpense} income={totalIncome}/></Heading>
                </Box>
